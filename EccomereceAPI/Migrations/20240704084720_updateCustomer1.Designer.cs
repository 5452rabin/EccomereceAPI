...
namespace EccomereceAPI.Migrations
{
    ...
    [Migration("20240704084720_updateCustomer1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommerece_DAL.Model.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Ecommerece_DAL.Model.CategoryPhoto", b =>
                {
                    b.Property<int>("CategoryPhotoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CategoryPhotoId"), 1L, 1);
            ...
            modelBuilder.Entity("Ecommerece_DAL.Model.Customer", b =>
                {
            ...
            modelBuilder.Entity("Ecommerece_DAL.Model.Order_Product", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ecommerece_DAL.Model.Product", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ecommerece_DAL.Model.ProductPhoto", b =>
                {
                    ...
                    b.Property<string>("ProductPhotoName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Ecommerece_DAL.Model.Order", b =>
                {
                    b.HasOne("Ecommerece_DAL.Model.Customer", "Customer")
                        .WithOne("Order")
                        .HasForeignKey("Ecommerece_DAL.Model.Order", "CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Ecommerece_DAL.Model.ApplicationUser", null)
                        .WithMany()
